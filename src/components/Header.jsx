            ...
            <div className='container mx-auto xl:max-w-[1274px] xl:px-3 px-6 '>
                <div className='flex flex-row flex-wrap justify-center xl:pl-[58px]'>
                    ...
                    <div className='lg:w-[50%] md:w-[84%] lg:mt-0 sm:mt-[45px] mt-[30px] sm:w-[90%] w-full flex items-center justify-center relative'>
                        ...
                        <div className='bg-[#FF6A64] py-[12px] animate-[mover_3000ms_ease-in-out_infinite] sm:px-[30px] px-[25px] rounded-[10px] shadow-[0px_4px_4px_0px_#00000040] absolute top-[7%] right-0'>
                        ...
                        <div className='bg-[#FF6A64] py-[12px] animate-[mover_3000ms_ease-in-out_infinite] sm:px-[30px] px-[25px] rounded-[10px] shadow-[0px_4px_4px_0px_#00000040] absolute bottom-[7%] left-[2%] '>
