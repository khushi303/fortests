            ...
            <div className='container mx-auto xl:max-w-[1164px] xl:px-3 px-6'>
                ...
                <div className='lg:mt-[70px] mt-[44px] flex justify-between flex-row flex-wrap'>
                    <div className='lg:w-[48%] w-full'>
                        <div className='border-[4px] border-solid border-[#0F244029] flex flex-row sm:gap-[30px] gap-[10px] shadow-[8px_8px_0px_0px_#DF4741] sm:py-[21px] sm:pl-[33px] sm:pr-[30px] p-[14px] rounded-[20px]'>
                    ...
                    <div className='lg:w-[48%] w-full mt-[40px]'>
                        <div className='border-[4px] border-solid border-[#0F244029] flex flex-row gap-[10px] shadow-[8px_8px_0px_0px_#DF4741] sm:py-[21px] pl-[8px] sm:pr-[30px] py-[14px] pr-[14px] rounded-[20px]'>
